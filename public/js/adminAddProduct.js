document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", (e) => {
        ...
        const side = document.getElementById("sideImage").files;
        const back = document.getElementById("backImage").files;

        if (cover.length === 0) {
            showError("coverError", "Front cover image required");
        }

        if (side.length === 0) {
            showError("sideError", "Side view image required");
        }

        if (back.length === 0) {
            showError("backError", "Back view image required");
        }
